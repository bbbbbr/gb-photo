...
const uint8_t * const screen_tile_addresses[DEVICE_SCREEN_HEIGHT] = {
    ...
    TO_TILE_ADDRESS(_VRAM8800, 0x94),
    TO_TILE_ADDRESS(_VRAM8800, 0xA8),
    TO_TILE_ADDRESS(_VRAM8800, 0xBC),
    TO_TILE_ADDRESS(_VRAM8800, 0xD0),
    TO_TILE_ADDRESS(_VRAM8800, 0xE4),
    TO_TILE_ADDRESS(_VRAM8800, 0x00),
    TO_TILE_ADDRESS(_VRAM8800, 0x14),
    TO_TILE_ADDRESS(_VRAM8800, 0x28),
    TO_TILE_ADDRESS(_VRAM8800, 0x3C),
    TO_TILE_ADDRESS(_VRAM8800, 0x50),
    TO_TILE_ADDRESS(_VRAM8800, 0x64),
    TO_TILE_ADDRESS(_VRAM8000, 0x00),
    TO_TILE_ADDRESS(_VRAM8000, 0x14),
    TO_TILE_ADDRESS(_VRAM8000, 0x28),
    TO_TILE_ADDRESS(_VRAM8000, 0x3C),
    TO_TILE_ADDRESS(_VRAM8000, 0x50),
    TO_TILE_ADDRESS(_VRAM8000, 0x64)
};
...
void screen_load_image_banked(uint8_t x, uint8_t y, uint8_t w, uint8_t h, const uint8_t * picture, uint8_t bank) {
    ...
    SWITCH_ROM_FORCE_MBC3(bank);
    screen_load_image(x, y, w, h, picture);
    SWITCH_ROM_FORCE_MBC3(save);
}
