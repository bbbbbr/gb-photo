    ...
    if (image_captured()) {
        ...
        if (COUNTER_CHANGED(camera_AEB_counter)) {
            ...
            if (slitscan_is_capturing() != true) {
                ...
                SWITCH_RAM_FORCE_MBC3(CAMERA_BANK_REGISTERS);  // restore register bank after histogram calculating
                ...
                switch (menu_result = menu_popup_camera_execute()) {
                    ...
                    case ACTION_ACTION_TRANSF_VIDEO: {
                        static const after_action_e aactions[] = {
                            ...
                            after_action_picnrec_video, after_action_transfer_video, after_action_slitscan_mode
                        };
